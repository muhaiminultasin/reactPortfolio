...
const ServicesContent = () => {
  ...
  useEffect( () => {
    const context = gsap.context( () => {
      gsap.from(ServicesContentRef.current.querySelector("p"), {
        x:100,
        duration:0.5,
        opacity:0,
        scrollTrigger:{
          trigger:ServicesContentRef.current,
        },
        stagger:{
          each:0.2,
        },
  ...
  return (
    <div ref={ServicesContentRef}  className='px-[20px] md:px-[80px] bg-blur-lg text-start  text-[18px] overflow-y-hidden'>
